    ...
    <div class="gridcontainer">
        <div class="item">
            ...
            <form method="get" name="form" action="searchbooks.php">
                ...
                <?php $_SESSION['type'] = "Title" ?>
                <input type="hidden" name="inp_author" value="LEAVE BLANK">
                <input type="submit" value="Search By Title">
            </form>
            <form method="get" name="form" action="searchbooks.php">
                <p>By Author: <input type="text" name="inp_author"></p>
                <?php $_SESSION['type'] = "Author" ?>
                <input type="hidden" name="inp_title" value="LEAVE BLANK">
            ...
            <table style="width:100%">
                ...
                <?php
                    ...
                    $res = mysqli_query($mysqli, "SELECT * FROM bookcase ORDER BY author, title");
